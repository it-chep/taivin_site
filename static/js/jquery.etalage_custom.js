	...
	$.fn.etalage = function(options){
		...
		$.each(this, function(){
			...
			if($container.is('ul') && $container.children('li').length && $container.find('img.etalage_source_image').length){
				...
				var i, j, src, thumb_id, magnifier_opacity, description, container_outerwidth, smallthumbs_overflow, css,
                ...
                if (typeof(window.autotimer) == "undefined") {
                    window.autotimer = 0;
                }
...
// NEW ELEMENTS & CACHE
				...
				var $thumb_images = $thumbs.find('.etalage_thumb_image').css({ width:o.thumb_image_width, height:o.thumb_image_height_auto }).show();
				...
				var $zoom_img = $zoom_img_area.children('.etalage_zoom_img').css({ width: 'auto', height:o.source_image_height });
...
// PREPARE
				...
				if(images > 1 || !o.smallthumb_hide_single){
					...
					if(smallthumbs_align==='vert'){
						...
						smallthumb_width = Math.round((o.thumb_image_width * smallthumb_height) / o.thumb_image_height_auto);
						...
						smallthumb_height = Math.round((o.thumb_image_height_auto * smallthumb_width) / o.thumb_image_width);
						smallthumb_outerwidth = smallthumb_width+smallthumb_border+smallthumb_padding;
						smallthumb_outerheight = smallthumb_height+smallthumb_border+smallthumb_padding;
					}
				}
